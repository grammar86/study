...
(function (r) {
	...
	function bc(a) {
		this.colorsDefault = ["#b0d972", "#68b523", "#90cb39", "#448d13", "#657608", "#d8d972", "#a6b523", "#c2cb39", "#838d14","#347608" ];
	...
	function pb(a) {
		this.defaults = {
			...
			visible: true,
			font: "11px sans-serif",
			textFillStyle:"white", /*  2021년 3월 수정 data label color ---white로 변경 */
			textLineWidth: 0,
			inactiveTextLineWidth: 0,
			itemsHorMargin: 1,
			itemsVerMargin: 0,
			allowHideSeries: true,
			inactiveTextFillStyle: "#bababa",/*  2021년 3월 수정 data label active color 변경 */
			inactiveFillStyle: "#bababa",/*  2021년 3월 수정 data label active color 변경 */
			inactiveStrokeStyle: "#bababa"/*  2021년 3월 수정 data label active color 변경 */
		};
		this.setOptions(a)
	}
	...
	pb.prototype._init = function () {
		...
		if (this.customItems)
			for (var d = 0; d < this.customItems.length; d++) {
				...
				c.textFillStyle = b.text.fillStyle || "white";
